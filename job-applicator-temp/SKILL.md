...
|---------------|-------------|
| AI Automation, Agentic AI, MCP, n8n, LLM Automation, AI Engineer, Automation Engineer | `Harsha_Yellela_AI-Automation-Engineer.pdf` |
| ML, Data Science, NLP, CV, Deep Learning | `Harsha_Yellela_ML-Engineer.pdf` |
...
| Salary Range | $80,000 - $100,000 (negotiable) |
...
|-----------|-------------------|
| AI Automation Engineer | LinkedIn, Wellfound, Remotive, RemoteOK |
